 ...
 */
#ifndef INCLUDED_WIFI_UTILS_H
#define INCLUDED_WIFI_UTILS_H

#include <gnuradio/wifi/mapper.h>
#include <cinttypes>
#include <iostream>
...
#define mylog(msg) do { if(d_log) { GR_LOG_INFO(_logger, msg); }} while(0);
