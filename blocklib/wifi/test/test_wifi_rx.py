...
def main():
    ...
    if 0: 
        ...
        fg.connect(cpmgsq, 0, maff, 0) #.set_custom_buffer(gr.buffer_cuda_sm_properties.make(gr.buffer_cuda_sm_type.H2D)) #.set_buffer_size(65536*4))
        fg.connect(mult, 0, macc, 0) #.set_custom_buffer(gr.buffer_cuda_properties.make(gr.buffer_cuda_type.H2D))
        fg.connect(macc, 0, cpmg, 0) #.set_custom_buffer(gr.buffer_cuda_properties.make(gr.buffer_cuda_type.D2H))
        fg.connect(sync_short, 0, dly1, 0)
        fg.connect(sync_short, 0, sync_long, 0)
        fg.connect(dly1, 0, sync_long, 1)
        fg.connect(cpmg, 0, div, 0)
        fg.connect(maff, 0, div, 1) #.set_custom_buffer(gr.buffer_cuda_sm_properties.make(gr.buffer_cuda_sm_type.D2H))

        fg.connect(dly0, 0, sync_short, 0)
        fg.connect(macc, 0, sync_short, 1) #.set_custom_buffer(gr.buffer_cuda_properties.make(gr.buffer_cuda_type.D2H))
        ...
        buf_size = 1024*1024
        fg.connect(src, 0, pre_sync, 0).set_custom_buffer(gr.buffer_cuda_properties.make(gr.buffer_cuda_type.H2D).set_buffer_size(buf_size))
        fg.connect(pre_sync, 0, snk1, 0).set_custom_buffer(gr.buffer_cuda_properties.make(gr.buffer_cuda_type.D2H).set_buffer_size(buf_size))
        fg.connect(pre_sync, 1, snk2, 0).set_custom_buffer(gr.buffer_cuda_properties.make(gr.buffer_cuda_type.D2H).set_buffer_size(buf_size))
        fg.connect(pre_sync, 2, snk3, 0).set_custom_buffer(gr.buffer_cuda_properties.make(gr.buffer_cuda_type.D2H).set_buffer_size(buf_size))
        ...
        fg.connect(pre_sync, 1, sync_short, 1).set_custom_buffer(gr.buffer_cuda_properties.make(gr.buffer_cuda_type.D2D).set_buffer_size(buf_size))
        fg.connect(pre_sync, 2, sync_short, 2).set_custom_buffer(gr.buffer_cuda_properties.make(gr.buffer_cuda_type.D2D).set_buffer_size(buf_size))
        # fg.connect(sync_short,0, dly1,0).set_custom_buffer(gr.buffer_cuda_properties.make(gr.buffer_cuda_type.D2H).set_buffer_size(buf_size))
        # fg.connect(sync_long, 0, snk, 0)
        fg.connect(sync_short, 0, sync_long, 0).set_custom_buffer(gr.buffer_cuda_properties.make(gr.buffer_cuda_type.D2D).set_buffer_size(buf_size))
        ...
        # fg.connect(dly1, 0, sync_long, 1) #.set_custom_buffer(gr.buffer_cpu_vmcirc_properties.make(gr.buffer_cpu_vmcirc_type.AUTO).set_buffer_size(buf_size))
        fg.connect(ns, 0, sync_long, 1) #.set_custom_buffer(gr.buffer_cpu_vmcirc_properties.make(gr.buffer_cpu_vmcirc_type.AUTO).set_buffer_size(buf_size))
        fg.connect(fft_blk, 0, frameeq, 0).set_custom_buffer(gr.buffer_cuda_properties.make(gr.buffer_cuda_type.D2H).set_buffer_size(buf_size))
        fg.connect(frameeq, 0, snk, 0) #.set_custom_buffer(gr.buffer_cuda_properties.make(gr.buffer_cuda_type.D2H).set_buffer_size(buf_size))
        ...
        # fg.connect(dly1, 0, sync_long, 1) #.set_custom_buffer(gr.buffer_cpu_vmcirc_properties.make(gr.buffer_cpu_vmcirc_type.AUTO).set_buffer_size(buf_size))
        fg.connect(fft_blk, 0, frameeq, 0).set_custom_buffer(gr.buffer_cuda_properties.make(gr.buffer_cuda_type.D2H).set_buffer_size(buf_size))
        # fg.connect(fft_blk, 0, frameeq, 0).set_custom_buffer(gr.buffer_cuda_properties.make(gr.buffer_cuda_type.D2D).set_buffer_size(buf_size))
        fg.connect(frameeq, 0, snk, 0) #.set_custom_buffer(gr.buffer_cuda_properties.make(gr.buffer_cuda_type.D2H).set_buffer_size(buf_size))
        # fg.connect(frameeq, 0, decode_mac, 0).set_custom_buffer(gr.buffer_cuda_properties.make(gr.buffer_cuda_type.D2H).set_buffer_size(buf_size))
        # fg.connect(frameeq, 0, decode_mac, 0) #.set_custom_buffer(gr.buffer_cuda_properties.make(gr.buffer_cuda_type.D2H).set_buffer_size(buf_size))
